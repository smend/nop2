...
namespace Nop.Services.Discounts
{
    ...
    public partial class DiscountRequirementValidationResult
    {
        ...
        /// <summary>
        /// new list for diduction products. maybe can only be declarive. bad for pref  @shlomi
        /// </summary>
        public List<ShoppingCartItem> productsForDeduction = new List<ShoppingCartItem>();
    }
}

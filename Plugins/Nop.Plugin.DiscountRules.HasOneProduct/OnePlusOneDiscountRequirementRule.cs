...
{
    public partial class OnePlusOneDiscountRequirementRule : BasePlugin, IDiscountRequirementRule
    {
        private readonly ISettingService _settingService;
        List<ShoppingCartItem> scis;
        int valids = 0;
        public OnePlusOneDiscountRequirementRule(ISettingService settingService)
        {
        ...
        public string GetConfigurationUrl(int discountId, int? discountRequirementId)
        {
            ...
            string result = "Plugins/DiscountRulesOnePlusOne/Configure/?discountId=" + discountId;
        ...
        {
            //locales
            this.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.OnePlusOne.Fields.Products", "Restricted products [and quantity range]");
            this.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.OnePlusOne.Fields.Products.Hint", "The comma-separated list of product identifiers (e.g. 77, 123, 156). You can find a product ID on its details page. You can also specify the comma-separated list of product identifiers with quantities ({Product ID}:{Quantity}. for example, 77:1, 123:2, 156:3). And you can also specify the comma-separated list of product identifiers with quantity range ({Product ID}:{Min quantity}-{Max quantity}. for example, 77:1-3, 123:2-5, 156:3-8).");
            this.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.OnePlusOne.Fields.Products.AddNew", "Add product");
            this.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.OnePlusOne.Fields.Products.Choose", "Choose");
            base.Install();
        }
        ...
        {
            //locales
            this.DeletePluginLocaleResource("Plugins.DiscountRules.OnePlusOne.Fields.Products");
            this.DeletePluginLocaleResource("Plugins.DiscountRules.OnePlusOne.Fields.Products.Hint");
            this.DeletePluginLocaleResource("Plugins.DiscountRules.OnePlusOne.Fields.Products.AddNew");
            this.DeletePluginLocaleResource("Plugins.DiscountRules.OnePlusOne.Fields.Products.Choose");
            base.Uninstall();
        }
    }
}
...
using Nop.Plugin.DiscountRules.OnePlusOne.Models;
using Nop.Services;
...
namespace Nop.Plugin.DiscountRules.OnePlusOne.Controllers
{
    [AdminAuthorize]
    public class DiscountRulesOnePlusOneController : BasePluginController
    {
        ...
        public DiscountRulesOnePlusOneController(IDiscountService discountService,
        ...
        public ActionResult Configure(int discountId, int? discountRequirementId)
        {
            ...
            //add a prefix
            ViewData.TemplateInfo.HtmlFieldPrefix = string.Format("DiscountRulesOnePlusOne{0}", discountRequirementId.HasValue ? discountRequirementId.Value.ToString() : "0");

            return View("~/Plugins/DiscountRules.OnePlusOne/Views/DiscountRulesOnePlusOne/Configure.cshtml", model);
        }
        ...
        public ActionResult Configure(int discountId, int? discountRequirementId, string productIds)
        {
            ...
            else
            {
                ...
                {
                    DiscountRequirementRuleSystemName = "DiscountRequirement.OnePlusOne"
                };
        ...
        public ActionResult ProductAddPopup(string btnId, string productIdsInput)
        {
            ...
            return View("~/Plugins/DiscountRules.OnePlusOne/Views/DiscountRulesOnePlusOne/ProductAddPopup.cshtml", model);
        }
